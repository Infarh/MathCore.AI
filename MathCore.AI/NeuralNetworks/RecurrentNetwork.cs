...
{
    protected readonly double[][,] _LayerFeedbacks;
    protected readonly double[][] _LastOutputs;
    protected readonly double[] _Output;

    public RecurrentNetwork(double[][,] Weights, double[][,] LayerFeedbacks)
        : base(Weights)
    {
    ...
    private RecurrentNetwork(int InputsCount, IReadOnlyList<int> NeuronsCount, LayerInitializer LayerInitializer)

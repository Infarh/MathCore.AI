...
namespace MathCore.AI.NeuralNetworks
{
    ...
    public partial class MultilayerPerceptron : ILayeredNetwork, IEquatable<MultilayerPerceptron>
    {
        ...
        [NotNull] protected readonly double[][] _OffsetsWeights;

        /// <summary>Массив выходов скрытых слоёв</summary>
        [NotNull] protected readonly double[][] _Outputs;

        /// <summary>Функции активации слоёв</summary>
        [NotNull] protected readonly ActivationFunction[] _Activations;
        ...
        [NotNull] public IReadOnlyList<double[]> OffsetWeights => _OffsetsWeights;
        ...
        public MultilayerPerceptron([NotNull] params double[][,] Layers)
        {
        ...
        /// <param name="Activations">Массив активационных функций слоёв (если функция не задана, используется Сигмоида)</param>
        ...
        /// Может применяться в процессе обущения сети.
        ...
        public void SaveXmlTo([NotNull] string FileName)
        {
        ...
        /// <param name="Writer">Объект записи данных XML</param>
        private void WriteLayers([NotNull] XmlWriter Writer)
        {
        ...
        /// <param name="Writer">Объект записи данных XML</param>
        /// <param name="LayerIndex">Индекс слоя</param>
        private void WriteNeurons([NotNull] XmlWriter Writer, int LayerIndex)
        {
        ...
        private void WriteNeuron([NotNull] XmlWriter Writer, int LayerIndex, int NeuronIndex, [NotNull] double[,] LayerWeights)
        {
        ...
        /// <returns>Прочитанная нейронная сеть</returns>
        [NotNull]
        public static MultilayerPerceptron LoadXmlFrom([NotNull] XmlReader Reader)
        {
        ...
        public static bool operator ==([CanBeNull] MultilayerPerceptron net1, [CanBeNull] MultilayerPerceptron net2) => ReferenceEquals(net1, net2) || net1?.Equals(net2) == true;

        public static bool operator !=([CanBeNull] MultilayerPerceptron net1, [CanBeNull] MultilayerPerceptron net2) => !(net1 == net2);
